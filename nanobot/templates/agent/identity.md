...
- Long-term memory: {{ workspace_path }}/{{ memory_file_path }} (automatically managed by Dream — do not edit directly)
- History log: {{ workspace_path }}/{{ history_file_path }} (append-only JSONL; prefer built-in `grep` for search).
